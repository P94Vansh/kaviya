...
<div className="max-w-sm p-6 bg-white border border-red-200 rounded-lg  dark:border-black shadow-xl">
   <div className='flex justify-between'> <div>Title Of the Scheme</div>
    <svg className="w-7 h-7 text-black dark:text-black mb-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
    ...
    <p className="mb-3 font-normal text-black dark:text-black">Go to this step by step guideline process on how to certify htmlFor your weekly benefits:</p>
